...
const products = [
  ...
  },
  {
    ...
    image: "../basic_html_css/assets/smartwatch.webp",
    productDescription:
...
function displayProducts() {
  ...
  for (const i in products) {
    ...
    detail.addEventListener('click', (evt) => {
      const productId = i;
      document.location.href = `../productdetail.html?productId=${productId}`;
    })
